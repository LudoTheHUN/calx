...
This version of Calx has some added functionality (vs ztellman's original)  to expose some of the OpenCL environment for greater control as to when kernels will be executed.

To install, just add this to your project.clj
<pre><code>[org.clojars.ludothehun/calx "0.4.1-SNAPSHOT"]
</code></pre>
